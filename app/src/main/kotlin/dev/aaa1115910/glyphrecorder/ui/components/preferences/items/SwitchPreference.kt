package dev.aaa1115910.glyphrecorder.ui.components.preferences.items
...
import dev.aaa1115910.glyphrecorder.ui.components.preferences.PreferenceGroupScope
import dev.aaa1115910.glyphrecorder.util.PreferenceRequest
import dev.aaa1115910.glyphrecorder.util.dataStore
import dev.aaa1115910.glyphrecorder.util.editPreference
...
fun PreferenceGroupScope.switchPreference(
    ...
    preferences += { shape, modifier ->
        ...
        val checked by dataStore.getPreferenceAsState(prefReq)
        val setChecked = { newValue: Boolean ->
            scope.launch(Dispatchers.IO) {
                dataStore.editPreference(prefReq.key, newValue)
            }
